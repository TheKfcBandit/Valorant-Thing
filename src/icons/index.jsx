...
// Crosshair-target glyph for the death-heatmap tab (#37). Concentric ring
// + crosshair, signalling "where things landed."
export function HeatmapTab({ size = 18, className = "", ...rest }) {
  return (
    <svg
      width={size}
      height={size}
