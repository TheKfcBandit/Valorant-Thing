    ...
    >
      <header>
        ...
        <p className="text-xs text-text-muted">
          Send your last 10 matches to your chosen LLM for personalized tips. Uses your own API key
          — no app cost.
        </p>
      </header>
      ...
      >
        ...
        <div>
          <label className="text-[10px] font-display font-bold text-text-muted uppercase tracking-wider">
            API key
          </label>
          <input
            type="password"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                persist("coach_model", e.target.value);
              }}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  persist("coach_base_url", e.target.value);
                }}
      ...
      {error && (
        <div className="px-3 py-2 rounded-md border border-val-red/40 bg-val-red/10 text-sm text-val-red whitespace-pre-wrap">
          {error}
        </div>
      )}
